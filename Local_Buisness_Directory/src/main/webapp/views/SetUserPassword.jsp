...
<body>
    ...
    <div class="registration-form">
        <h2 class="form-title">Set New User Password</h2>
        <form id="registrationForm" action="setPassword?id=${User_model.id}" onsubmit="return validateForm()" method="post">
            <div class="form-group">
                <label for="userId">User ID</label>
                <input type="text" id="userId" name="userId" value="${User_model.id}" readonly>
            </div>

            <div class="form-group">
                <label for="name">Full Name</label>
                <input type="text" id="name" name="name" value="${User_model.name}" readonly>
            </div>

            <div class="form-group">
                <label for="email">Email Address</label>
                <input type="email" id="email" name="email" value="${User_model.email}" readonly>
            </div>

            <div class="form-group">
                <label for="mobile">Mobile Number</label>
                <input type="text" id="mobile" name="mobile" value="${User_model.mobile}" readonly>
            </div>
