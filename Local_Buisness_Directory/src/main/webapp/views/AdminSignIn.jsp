...
<body>
    ...
    <div class="login-form">
        ...
        <form id="loginForm" onsubmit="return validateLoginForm()" action="CheckAdminLogin">
            ...
            <div class="form-group">
                ...
                <center><a href="AdminPasswordForgot">forgot password.</a></center>
            </div>

        </form>
        <!-- This will be replaced by the server-side error message -->
    ...
    <script>
        ...
        // Check if there is an error message and show SweetAlert
        window.onload = function() {
            // You can set this `errorMessage` from your server-side logic or dynamically
            var errorMessage = "${error}"; // This should be the error message you pass to the page
